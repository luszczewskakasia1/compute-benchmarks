...
class SetKernelArgSvmPointerTest : public ::testing::TestWithParam<std::tuple<size_t, bool, size_t>> {
};
...
TEST_P(SetKernelArgSvmPointerTest, Test) {
    ...
    args.reallocate = std::get<1>(GetParam());
    args.allocationSize = std::get<2>(GetParam());
