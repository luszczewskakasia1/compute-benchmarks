...
static const inline RegisterTestCase<ReadBufferRect> registerTestCase{};

using Tuple = ThreeComponentUintArgument::TupleType;
class ReadBufferRectTestEntireBuffer : public ::testing::TestWithParam<std::tuple<bool, Tuple>> {
};
...
INSTANTIATE_TEST_SUITE_P(
    ReadBufferRectTestEntireBuffer,
    ReadBufferRectTestEntireBuffer,
    ::testing::Combine(
