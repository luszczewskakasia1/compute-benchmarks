...
int printHelp() {
    ...
    std::cout << "UllsBenchmark is a set of tests aimed at measuring Ultra Low Latency Submission (ULLS) performance impact. "
                 ...
                 "\t--api=X               - select graphics API to use. Possible values: ocl, l0, all\n"
                 "\t--oclPlatform=X       - OpenCL platform index.\n"
                 "\t--oclDevice=X         - OpenCL device index inside the platform.\n"
                 "\t--oclUseOOQ=X         - Use out of order queue if it is supported.\n"
                 "\t--l0Driver=X          - LevelZero driver index.\n"
                 "\t--l0Device=X          - LevelZero device index inside the driver.\n"
                 "\n"
                 "Example invocations:\n"
                 "\t" << filename << "\n"
                 "\t" << filename << " --api=l0\n"
